    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-col items-center p-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-xl w-full mb-12">
          ...
          <p className="text-lg text-center text-gray-600 mb-4">Shaksuka</p>
...
const menu1 = [
  ...
  { title: "Tussendoortje", color: "text-orange-500", items: ["2 pindacrunchrepen"] },
  { title: "Lunch", color: "text-red-500", items: ["250 gr rauwkostsalade met dressing naar keuze", "2 crackers met kaas", "1 cracker met appelstroop"] },
  { title: "Tussendoortje", color: "text-red-600", items: ["250 gr fruitsalade van fruit naar keuze"] },
  { title: "Diner", color: "text-red-700", items: ["Groene shaksuka"] },
