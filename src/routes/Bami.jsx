        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <ul className="list-inside list-disc">
                <li>2 sneeën roggebrood met kaas</li>
                <li>200 ml melk</li>
              </ul>
            </div>
            ...
            <div className="space-y-1">
              ...
              <ul className="list-inside list-disc">
                <li>Een vla flip van: 75 gr yoghurt, 75 gr vanillevla, 50 gr frambozen</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <ul className="list-inside list-disc">
                ...
                <li>1 beschuit met appelstroop</li>
              </ul>
            </div>
