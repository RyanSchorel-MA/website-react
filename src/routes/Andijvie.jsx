  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="flex flex-col items-center justify-center text-center p-4 bg-white rounded-lg shadow-lg max-w-lg w-full mx-auto mt-6">
        <h1 className="text-3xl font-bold text-center mb-6">Andijvie</h1>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <ul className="list-inside list-disc">
                <li>2 beschuiten met appelstroop</li>
                <li>1 beschuit met kaas</li>
              </ul>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <ul className="list-inside list-disc">
                ...
                <li>1 snee brood met groentespread en rauwkost
                </li>
                <li>200 ml melk
                </li>
              </ul>
            ...
            <div className="space-y-1">
              ...
              <ul className="list-inside list-disc">
                <li>6 toastjes met zuivelspread</li>
              </ul>
            </div>
