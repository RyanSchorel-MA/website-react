    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-col items-center p-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-xl w-full mb-12">
          ...
          <p className="text-lg text-center text-gray-600 mb-4">Patat</p>
...
// Menu 1
const menu1 = [
  { title: "Ontbijt", color: "text-yellow-500", items: ["200 ml melk", "40 gr havermout", "1 kiwi"] },
  { title: "Tussendoortje", color: "text-orange-500", items: ["2 rijstwafels met pindakaas"] },
  { title: "Lunch", color: "text-red-500", items: ["2 sneeën brood met zuivelspread en rauwkost", "1 snee brood met jam", "250 gr druiven"] },
  { title: "Tussendoortje", color: "text-red-600", items: ["200 gr yoghurt", "25 gr granola"] },
  { title: "Diner", color: "text-red-700", items: ["Patat"] },
  { title: "Snack", color: "text-red-800", items: ["250 gr rauwkost", "1 gekookt ei"] },
];
...
const menu2 = [
  ...
  { title: "Lunch", color: "text-red-500", items: ["250 gr rauwkostsalade met dressing naar keuze", "2 crackers met magere vleeswaren", "1 cracker met appelstroop", "200 ml melk"] },
  { title: "Tussendoortje", color: "text-red-600", items: ["250 gr fruitsalade van fruit naar keuze"] },
  { title: "Diner", color: "text-red-700", items: ["Patat"] },
  { title: "Snack", color: "text-red-800", items: ["1 appel", "kaneel naar smaak"] },
];
